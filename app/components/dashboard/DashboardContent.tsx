...
export default function DashboardContent({
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "created":
        return (
          <Badge className="bg-blue-500/10 text-blue-500 hover:bg-blue-500/20 border-blue-500/20 animate-pulse">
            Processing
          </Badge>
        );
      case "failed":
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-400/70 text-sm">
                    ...
                    {processingProjects.length > 1 ? "s" : ""} currently being
                    analyzed.
                  </p>
                </div>
              </div>
        ...
        <DialogContent className="bg-zinc-900 border-zinc-800 text-zinc-200">
          <DialogHeader>
            ...
            <DialogDescription className="text-zinc-400">
              ...
              permanently remove all learning data, code chunks, and vector
