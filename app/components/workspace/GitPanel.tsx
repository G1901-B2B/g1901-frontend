...
import { ArrowDown, ArrowUp, GitBranch, GitCommit, X, History, AlertTriangle, GitMerge } from 'lucide-react'
import type { GitCommitEntry, GitStatusResponse, BranchInfo, CommitGraphEntry } from '../../lib/api-git'
    ...
    <Card className="bg-zinc-900/40 border-zinc-800 h-full flex flex-col">
      <CardContent className="p-4 flex flex-col flex-1 min-h-0">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full flex flex-col flex-1 min-h-0">
          ...
          <TabsContent value="status" className="mt-4 flex-1 min-h-0 overflow-hidden">
          ...
          <TabsContent value="history" className="mt-4 flex-1 min-h-0 overflow-hidden">
            <ScrollArea className="h-full w-full">
          ...
          <TabsContent value="branches" className="mt-4 flex-1 min-h-0 overflow-hidden">
            <ScrollArea className="h-full w-full">
              <div className="pr-4 pb-2">
          ...
          <TabsContent value="merge" className="mt-4 flex-1 min-h-0 overflow-hidden">
            <ScrollArea className="h-full w-full">
              <div className="pr-4 pb-2">
                {onMerge ? (
                  <MergeBranches
          ...
          {hasConflicts && (
            <TabsContent value="conflicts" className="mt-4 flex-1 min-h-0 overflow-hidden">
              <ScrollArea className="h-full w-full">
                <div className="pr-4 pb-2">
