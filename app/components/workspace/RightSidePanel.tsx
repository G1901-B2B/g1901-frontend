...
export default function RightSidePanel({
  ...
  return (
    <div className="bg-[#09090b] flex flex-col h-full">
      {/* Tabs */}
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'task' | 'git' | 'chat')} className="flex-1 flex flex-col min-h-0">
        ...
        <TabsContent value="task" className="flex-1 min-h-0 overflow-hidden mt-0">
          <TaskPanel
            task={task}
