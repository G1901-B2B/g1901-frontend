...
import "./globals.css";
import { RoutePerformanceLogger } from "./components/performance/RoutePerformanceLogger";
  ...
  return (
    <ClerkProvider
      ...
      appearance={{
        ...
        elements: {
          formButtonPrimary:
            "bg-zinc-900 hover:bg-zinc-800 text-[13px] font-medium normal-case transition-all duration-200",
          socialButtonsBlockButton:
            "border-zinc-300 hover:bg-zinc-50 text-[13px] transition-all duration-200",
