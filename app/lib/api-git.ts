...
export async function getGitDiff(
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to get diff" }));
...
export async function pullFromRemote(
  ...
  if (res.status === 409) {
    const error = await res
      .json()
      .catch(() => ({ detail: { message: "Uncommitted changes" } }));
...
export async function checkExternalCommits(
  ...
  const res = await fetch(
    `${API_BASE}/api/git/${workspaceId}/external-commits`,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
  );
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to check external commits" }));
...
export async function resetExternalCommits(
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to reset external commits" }));
...
export async function getCommits(
  ...
  try {
    ...
    const res = await fetch(
      `${API_BASE}/api/git/${workspaceId}/commits?${params}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export async function stageFiles(
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to stage files" }));
...
export async function unstageFiles(
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to unstage files" }));
...
export async function getFileDiff(
  ...
  const res = await fetch(
    `${API_BASE}/api/git/${workspaceId}/diff/${encodeURIComponent(filePath)}?${params}`,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
  );
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to get file diff" }));
...
export async function getCommitGraph(
  ...
  try {
    ...
    const res = await fetch(
      `${API_BASE}/api/git/${workspaceId}/commits/graph?${params}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export async function listBranches(
  ...
  try {
    ...
    const res = await fetch(
      `${API_BASE}/api/git/${workspaceId}/branches?${params}`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export async function createBranch(
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to create branch" }));
...
export async function checkoutBranch(
  ...
  const res = await fetch(
    `${API_BASE}/api/git/${workspaceId}/branches/checkout`,
    {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to checkout branch" }));
...
export async function deleteBranch(
  ...
  try {
    ...
    if (!res.ok) {
      const error = await res
        .json()
        .catch(() => ({ detail: "Failed to delete branch" }));
...
export async function getConflictContent(
  ...
  const res = await fetch(
    `${API_BASE}/api/git/${workspaceId}/conflicts/${encodeURIComponent(filePath)}`,
    {
      headers: { Authorization: `Bearer ${token}` },
    }
  );
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to get conflict content" }));
...
export async function resolveConflict(
  ...
  const res = await fetch(
    `${API_BASE}/api/git/${workspaceId}/conflicts/resolve`,
    {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to resolve conflict" }));
...
export async function mergeBranch(
  ...
  if (res.status === 409) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Merge conflicts detected" }));
    return {
      success: false,
      has_conflicts: true,
...
export async function abortMerge(
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to abort merge" }));
...
export async function resetToCommit(
  ...
  if (!res.ok) {
    const error = await res
      .json()
      .catch(() => ({ detail: "Failed to reset to commit" }));
