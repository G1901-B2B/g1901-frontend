...
export async function getRoadmap(
  projectId: string,
  token: string | null
): Promise<{ success: boolean; days: RoadmapDay[] }> {
  if (!token) {
...
export async function getDayDetails(
  ...
  dayId: string,
  token: string | null
): Promise<{ success: boolean } & DayDetails> {
  if (!token) {
    throw new Error("Authentication required");
  }
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/roadmap/${projectId}/day/${dayId}`,
    {
      headers,
    }
  );
...
export async function getConceptDetails(
  ...
  conceptId: string,
  token: string | null
): Promise<{ success: boolean } & ConceptDetails> {
  if (!token) {
    throw new Error("Authentication required");
  }
...
export async function getGenerationStatus(
  projectId: string,
  token: string | null
): Promise<{ success: boolean } & GenerationStatus> {
  if (!token) {
    throw new Error("Authentication required");
  }
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/roadmap/${projectId}/generation-status`,
    {
      headers,
    }
  );
...
export async function getProgress(
  projectId: string,
  token: string | null
): Promise<{ success: boolean } & UserProgress> {
  if (!token) {
    throw new Error("Authentication required");
  }
...
export async function getCurrentProgress(
  projectId: string,
  token: string | null
): Promise<{ success: boolean } & CurrentProgress> {
  if (!token) {
    throw new Error("Authentication required");
  }
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/current`,
    {
      headers,
    }
  );
...
export async function startConcept(
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/concept/${conceptId}/start`,
    {
      method: "POST",
      headers,
    }
...
export async function completeConcept(
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/concept/${conceptId}/complete`,
    {
      method: "POST",
      headers,
    }
...
export async function markContentRead(
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/concept/${conceptId}/content-read`,
    {
      method: "POST",
      headers,
    }
...
export async function startDay(
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/day/${dayId}/start`,
    {
      method: "POST",
      headers,
    }
...
export async function completeDay(
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/day/${dayId}/complete`,
    {
      method: "POST",
      headers,
    }
...
export async function getTaskDetails(
  taskId: string,
  token: string | null
): Promise<{ success: boolean } & TaskDetails> {
  if (!token) {
    throw new Error("Authentication required");
  }
...
export async function startTask(
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/task/${taskId}/start`,
    {
      method: "POST",
      headers,
    }
...
export async function completeTask(
  ...
  const headers = getAuthHeadersClient(token);
  const response = await fetch(
    `${API_BASE_URL}/api/progress/${projectId}/task/${taskId}/complete`,
    {
      method: "POST",
      headers: {
        ...headers,
