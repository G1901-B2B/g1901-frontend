      ...
      <div className="relative bg-[#3a3f44]/80 backdrop-blur-sm rounded-2xl border border-white/5 p-8 md:p-12">
        <div className="max-w-lg mx-auto text-center">
          ...
          <div className="relative w-24 h-24 mx-auto mb-8">
            ...
            {/* Spinning ring */}
            <div
              className="absolute inset-0 rounded-full border-4 border-transparent border-t-indigo-400 border-r-purple-400 animate-spin"
          ...
          <p className="text-zinc-400 mb-8 leading-relaxed">
            We&apos;re analyzing your repository and crafting a personalized
            curriculum. This usually takes 2-5 minutes.
          </p>
          ...
          <div className="space-y-3 text-left mb-8">
            {steps.map((step, index) => (
              ...
              >
                ...
                <span
                  className={`text-sm ${step.done ? "text-zinc-300" : "text-zinc-500"}`}
                >
                  {step.label}
                </span>
              </div>
          ...
          <div className="bg-white/5 rounded-xl p-4 text-left">
            ...
            <p className="text-sm text-zinc-400">
              While you wait, you can explore other projects or check out the
              dashboard. We&apos;ll have everything ready when you return!
            </p>
          </div>
        </div>
      </div>
